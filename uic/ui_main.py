...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("c:\\Users\\letan\\OneDrive\\Máy tính\\Macloed\\uic\\../icon/newspaper--plus.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNewDesign.setIcon(icon2)
        self.actionNewDesign.setObjectName("actionNewDesign")
        self.actionOpen = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\letan\\OneDrive\\Máy tính\\Macloed\\uic\\../icon/open_folder.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionOpen.setIcon(icon3)
        self.actionOpen.setObjectName("actionOpen")
        self.actionNewMaterial = QtGui.QAction(MainWindow)
        self.actionNewMaterial.setIcon(icon1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\letan\\OneDrive\\Máy tính\\Macloed\\uic\\../icon/chart.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionPlot.setIcon(icon4)
        self.actionPlot.setObjectName("actionPlot")
        self.actionTargets = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("c:\\Users\\letan\\OneDrive\\Máy tính\\Macloed\\uic\\../icon/geolocation.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionTargets.setIcon(icon5)
        self.actionTargets.setObjectName("actionTargets")
        self.actionOpenTargets = QtGui.QAction(MainWindow)
        self.actionOpenTargets.setIcon(icon3)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("c:\\Users\\letan\\OneDrive\\Máy tính\\Macloed\\uic\\../icon/calculator.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionCaculator.setIcon(icon6)
